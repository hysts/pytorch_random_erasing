...
def parse_args():
    ...
    # random erasing
    parser.add_argument(
        '--use_random_erase', action='store_true', default=False)
    parser.add_argument('--random_erase_prob', type=float, default=0.5)
    parser.add_argument(
        '--random_erase_area_ratio_range', type=str, default='[0.02, 0.4]')
    parser.add_argument(
        '--random_erase_min_aspect_ratio', type=float, default=0.3)
    parser.add_argument('--random_erase_max_attempt', type=int, default=20)
    ...
    data_config = OrderedDict([
        ...
        ('random_erase_area_ratio_range',
         json.loads(args.random_erase_area_ratio_range)),
        ('random_erase_min_aspect_ratio', args.random_erase_min_aspect_ratio),
        ('random_erase_max_attempt', args.random_erase_max_attempt),
    ])
